...
enum ProAccessService {
    ...
    static func requirePro(_ user: User) throws {
        guard user.hasLifetimePro else {
            throw Abort(.forbidden, reason: "This feature requires Hushful Pro. Upgrades will be available in the iOS app after launch. Web payments and Android are coming soon.")
        }
    }
